...
class _FlashScreenState extends State<FlashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _timer = Timer.periodic(const Duration(seconds: 3), (_) {
      ...
      final double currentPageDouble = _pageController.page ?? _pageController.initialPage.toDouble();
  ...
  child: Padding(
    ...
    child: Transform.translate(
      offset: const Offset(0, -40), // move entire content up by 40 pixels
      child: Column(
        ...
        children: [
          ...
          const Spacer(flex: 1), // reduce spacer to push carousel & Go button up
                ...
                children: List.generate(
                  ...
                  (dotIndex) => AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: _currentPage == dotIndex ? Colors.white : Colors.white38,
