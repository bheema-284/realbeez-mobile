...
class _BookServiceScreenState extends State<BookServiceScreen> {
                    ...
                    return TextButton(
                      ...
                      onPressed: isDisabled ? null : () {
                        setState(() {
                          ...
                          _selectedTimeSlot = null; // Reset selected time when month changes
                        });
                    ...
                    return TextButton(
                      ...
                      onPressed: isDisabled ? null : () {
                        setState(() {
                          ...
                          _selectedTimeSlot = null; // Reset selected time when year changes
                        });
                        Navigator.pop(context);
                      },
                      child: Text(
  ...
  bool _isTimeSlotAvailable(String time) {
    DateTime now = DateTime.now();
    DateTime selectedDateTime = DateTime(_selectedYear, 
        _months.indexOf(_selectedMonth) + 1, _selectedDate);
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: _showConfirmationDialog, // Show confirmation dialog instead of direct navigation
                        child: Text(
